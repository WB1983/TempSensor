...
# 1 "mcc_generated_files/../Modbus_uart/Modbus.h" 1
# 10 "mcc_generated_files/../Modbus_uart/Modbus.h"
uint16_t Reg[]={
                0x0000,
                0x0001,
                0x0002,
...
void TMR0_DefaultInterruptHandler(void){
    ...
    TModbusData * tModbusData = ((void*)0);
    tModbusData = Mos_PtGetModbusObject();

    u16Count++;


    if(tModbusData->u8TimeoutStart!=0)
  {
    tModbusData->u8TimeoutCount++;
    if(tModbusData->u8TimeoutCount>=8)
   {
    tModbusData->u8TimeoutStart=0;
    tModbusData->u8OneFrameFinish=1;
   }
  }
}
