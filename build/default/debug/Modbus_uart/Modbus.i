...
# 2 "<built-in>" 2
# 1 "Modbus_uart/Modbus.c" 2
# 1 "Modbus_uart/../Modbus_uart/Modbus.h" 1



# 1 "C:/Program Files/Microchip/MPLABX/v5.50/packs/Microchip/PIC12-16F1xxx_DFP/1.2.63/xc8\\pic\\include\\proc\\../pic.h" 1 3
...
# 4 "Modbus_uart/../Modbus_uart/Modbus.h" 2
...
# 5 "Modbus_uart/../Modbus_uart/Modbus.h" 2
...
# 1 "Modbus_uart/../Modbus_CRC/ModbusCRC.h" 1
# 19 "Modbus_uart/../Modbus_CRC/ModbusCRC.h"
 uint16_t crc16( uint8_t *puchMsg, uint16_t usDataLen );
# 2 "Modbus_uart/Modbus.c" 2


# 1 "Modbus_uart/../mcc_generated_files/pin_manager.h" 1
# 248 "Modbus_uart/../mcc_generated_files/pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 260 "Modbus_uart/../mcc_generated_files/pin_manager.h"
void PIN_MANAGER_IOC(void);
# 4 "Modbus_uart/Modbus.c" 2

# 1 "Modbus_uart/../mcc_generated_files/eusart.h" 1
# 55 "Modbus_uart/../mcc_generated_files/eusart.h"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\stdbool.h" 1 3
# 55 "Modbus_uart/../mcc_generated_files/eusart.h" 2
# 75 "Modbus_uart/../mcc_generated_files/eusart.h"
typedef union {
    struct {
        unsigned perr : 1;
        unsigned ferr : 1;
...
# 117 "Modbus_uart/../mcc_generated_files/eusart.h"
void EUSART_Initialize(void);
# 165 "Modbus_uart/../mcc_generated_files/eusart.h"
_Bool EUSART_is_tx_ready(void);
# 213 "Modbus_uart/../mcc_generated_files/eusart.h"
_Bool EUSART_is_rx_ready(void);
# 260 "Modbus_uart/../mcc_generated_files/eusart.h"
_Bool EUSART_is_tx_done(void);
# 308 "Modbus_uart/../mcc_generated_files/eusart.h"
eusart_status_t EUSART_get_last_status(void);
# 328 "Modbus_uart/../mcc_generated_files/eusart.h"
uint8_t EUSART_Read(void);
# 348 "Modbus_uart/../mcc_generated_files/eusart.h"
void EUSART_Write(uint8_t txData);
# 369 "Modbus_uart/../mcc_generated_files/eusart.h"
void EUSART_Transmit_ISR(void);
# 390 "Modbus_uart/../mcc_generated_files/eusart.h"
void EUSART_Receive_ISR(void);
# 411 "Modbus_uart/../mcc_generated_files/eusart.h"
void EUSART_RxDataHandler(void);
# 429 "Modbus_uart/../mcc_generated_files/eusart.h"
void EUSART_SetFramingErrorHandler(void (* interruptHandler)(void));
# 447 "Modbus_uart/../mcc_generated_files/eusart.h"
void EUSART_SetOverrunErrorHandler(void (* interruptHandler)(void));
# 465 "Modbus_uart/../mcc_generated_files/eusart.h"
void EUSART_SetErrorHandler(void (* interruptHandler)(void));
# 485 "Modbus_uart/../mcc_generated_files/eusart.h"
void EUSART_SetTxInterruptHandler(void (* interruptHandler)(void));
# 505 "Modbus_uart/../mcc_generated_files/eusart.h"
void EUSART_SetRxInterruptHandler(void (* interruptHandler)(void));
# 5 "Modbus_uart/Modbus.c" 2
...
{
 MOS_tModbusPara.u8DeviceAddress = 4;
...
void MOS_vModbudFun3()
{
 ...
 u16RegisterAdd=MOS_tModbusData.auReceiveBuff[2]*256+MOS_tModbusData.auReceiveBuff[3];
 u16RegisterLen=MOS_tModbusData.auReceiveBuff[4]*256+MOS_tModbusData.auReceiveBuff[5];

 MOS_tModbusData.auTransmitBuff[i++]=MOS_tModbusPara.u8DeviceAddress;
    MOS_tModbusData.auTransmitBuff[i++]=0x03;
   u16TransDataLen=u16RegisterLen*2;
...
void MOS_vModbudFun6()
{
 ...
 uint16_t j = 0;
   ...
   u16RegisterAdd=MOS_tModbusData.auReceiveBuff[2]*256+MOS_tModbusData.auReceiveBuff[3];
 u16value=MOS_tModbusData.auReceiveBuff[4]*256+MOS_tModbusData.auReceiveBuff[5];
 Reg[u16RegisterAdd]=u16value;
...
void MOS_vModBusHandler(void)
{
 ...
 if(0 == MOS_tModbusData.u8OneFrameFinish)
 {
  return;
 }
 ...
 u16CalculateCRC= crc16(&MOS_tModbusData.auReceiveBuff[0], MOS_tModbusData.u8ReceivedByteCount-2);

   u16ReceivedCRC= (MOS_tModbusData.auReceiveBuff[MOS_tModbusData.u8ReceivedByteCount-2]*256);
 u16ReceivedCRC = u16ReceivedCRC + MOS_tModbusData.auReceiveBuff[MOS_tModbusData.u8ReceivedByteCount -1];
   if(u16CalculateCRC == u16ReceivedCRC)
 {
   if(u16ReceivedAddress == MOS_tModbusPara.u8DeviceAddress)
  {
    switch(u16ReceivedFunctionCode)
   {
    ...
    case 1: break;
    case 2: break;
    case 3: MOS_vModbudFun3(); break;
    case 4: break;
    case 5: break;
    case 6: MOS_vModbudFun6(); break;
    case 7: break;
   }
  }
  else if(u16ReceivedAddress == 0)
  {
